...
<link href="{{ URL::asset('assets/js/lhgcalendar/lhgcalendar.css') }}" rel="stylesheet">

<script src="{{ URL::asset('assets/js/jquery-1.9.1.min.js') }}"></script>
<script src="{{ URL::asset('assets/js/bootstrap.min.js') }}"></script>
<script src="{{ URL::asset('assets/js/script.js') }}"></script>
<script src="{{ URL::asset('assets/js/lhgcalendar/lhgcore.min.js') }}"></script>
<script src="{{ URL::asset('assets/js/lhgcalendar/lhgcalendar.min.js') }}"></script>