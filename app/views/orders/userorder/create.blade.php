...
@section('main')
	...
	{{ Form::open(array('route' => 'user.order.post', 'name'=>'form', 'id'=>'form')) }}
	<div class="header ">
	...
	<div class="contTab">
		...
		<div class="table perList">
			<div class="person">
				<h2><span class="title">早上食堂就餐</span><a class="btn no"></a></h2>
				<p><a class="lower"></a>招待<span class="num">0</span>人<a class="add"></a></p>
				<input name="breakfast" id="breakfast" type="hidden" value=0 />
			</div>
		</div>
		<div class="table perList">
			<div class="person">
				<h2><span class="title">中午食堂就餐</span><a class="btn no"></a></h2>
				<p><a class="lower"></a>招待<span class="num">0</span>人<a class="add"></a></p>
				<input name="lunch" id="lunch" type="hidden" value=0 />
			</div>
		</div>
		<div class="table perList">
			<div class="person">
				<h2><span class="title">晚上食堂就餐</span><a class="btn no"></a></h2>
				<p><a class="lower"></a>招待<span class="num">0</span>人<a class="add"></a></p>
                <input name="dinner" id="dinner" type="hidden" value=0 />
			</div>
		</div>
	</div>
	{{ Form::close() }}
